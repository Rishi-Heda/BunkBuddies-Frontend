		...
		<BackgroundGrid>
			...
			>
				...
				<div className="w-full max-w-5xl mt-12 sm:mt-8 md:mt-12 lg:mt-16 space-y-4 sm:space-y-6 md:space-y-8 flex-1 flex flex-col pb-6 sm:pb-8">
					...
					<div
						className="w-full min-h-[120px] sm:min-h-[150px] md:min-h-[200px] max-h-[320px] bg-[#FD9E51] border border-black rounded-[5px] shadow-[4px_4px_0px_black] sm:shadow-[5px_5px_0px_black] md:shadow-[7px_7px_0px_black] overflow-y-auto p-4 sm:p-6 md:p-8 custom-scrollbar"
					...
					>
						...
						<ol className="list-decimal pl-4 space-y-3 text-black text-sm sm:text-base md:text-lg">
							...
							<li>
								...
								<br />
								Yes, creating a profile and browsing roommates is completely
								free.
							</li>
							<li>
							...
							<li>
								...
								<br />
								You can keep browsing and sending requests until you find
								someone who fits your lifestyle and vibe.
							</li>
							<li>
